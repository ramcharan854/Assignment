package test.notimeforataxicab;
...
import notimeforataxicab.NoTimeForATaxiCab;
import notimeforataxicab.Position;

class NoTimeForACabTest {
    ...
    public void follow_R8_R4_R4_R8_expect_4_blocks_twice() throws Exception {
        ...
        taxicab.followInstructions(path, ", ");
